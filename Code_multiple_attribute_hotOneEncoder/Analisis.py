...
def main(args):
    ...
    def discriminator(discr_type):
        ...
        if discr_type == "rnn":
            return NewRNN_discr(input_dim=latent_size, hidden_dim=args.hs_rnn_discr, output_dim=attr_size, n_layers = 2, bidirectional=True, dropout=0.7)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--attr_size', type=int, default=4)
    parser.add_argument('--discr_type', type=str, default='rnn')
