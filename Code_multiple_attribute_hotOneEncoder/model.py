...
class SentenceVAE(nn.Module):
    ...
    def decoder(self, input_sequence, z , input_embedding, sorted_lengths, batch_size):
    ...
    def forward(self, input_sequence, length, label, encoder=False):
        ...
        outputs = self.decoder(input_sequence, z_a, input_embedding, sorted_lengths, batch_size)
        # OUTPUT FORMAT
    ...
    def inference(self, labels, n=2, positive='True', z=None):
        ...
        if positive:
            ...
            b = np.array([[0, 0, 0, 1], [0, 0, 0, ]]).astype(np.float32)
        else:
