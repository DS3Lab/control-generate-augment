...
class PTB(Dataset):
    ...
    '''
    Class to preprocess the imdb dataset
    '''
    ...
    def __init__(self, data_dir, split, create_data, **kwargs):
        ...
        self.split = split
        self.max_sequence_length = kwargs.get('max_sequence_length', 50) # 50 is a deafult values if the key is not in the dictionary
